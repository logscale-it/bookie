...
// (INTEGER minor units). The legacy REAL columns (`net_amount`, `tax_amount`,
// `gross_amount`) were dropped from the schema in migration 0023.
//
 ...
 * - `net_cents`, `tax_cents`, `gross_cents`, `due_surcharge` are all negated.
 ...
 *   so the invariant line_total_cents = quantity * unit_price_cents holds.
